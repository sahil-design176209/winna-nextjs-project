...
export default function HotComboSection() {
    ...
    const TopEvents = () => (
        <div >
            ...
            <div className="space-y-2 bg-body-level-7 p-2 rounded-lg">
                <div className="flex justify-between text-[11px] text-typography-primary mb-4">
                    <span className=" opacity-75 flex gap-2 "> <svg
                        viewBox="0 0 32 32"
                        fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-4 h-4"
                    ...
                    </svg>t20 women's</span>
                    <span className="opacity-75 ">Tuesday, 01:41 PM</span>
                </div>
                ...
                <div className="flex items-center justify-center gap-2 mb-6">
                    <div className="w-[110px] h-10 rounded-md bg-[#2A364A]" />

                    <div className="w-12 h-10 rounded-md bg-[#152536] flex items-center justify-center text-[16px] text-typography-primary font-bold  opacity-75">
                        X
                    </div>
                ...
                <button className="w-full h-11 rounded-lg bg-accent-blue hover:bg-accent-blue text-white font-semibold transition">
                    Go To Event
                </button>
            </div>
        </div>
